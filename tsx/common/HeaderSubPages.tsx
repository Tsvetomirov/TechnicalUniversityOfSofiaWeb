                            ...
                            <div className="navbar-header">
                                <div className="brand">
                                    <a href="../../html/portal/index.html">
                                        {this.props.windowReducer.viewType === ViewType.LANDSCAPE &&
                                        <div className="miniLogoContainer">
                                            ...
                                            <div className={"animated-logo"}>
                                                ...
                                                <div
                                                    className={"miniSecondFigure " + (Utils.isNotNull(Utils.getURLPageName(window.location.href) === "index.html") ? "homePage" : "")}
                                                    id="miniSecondFigure">
                                                ...
                                                <div
                                                    className={"miniThirdFigure " + (Utils.isNotNull(Utils.getURLPageName(window.location.href) === "index.html") ? "homePage" : "")}
                                                    id="miniThirdFigure">
