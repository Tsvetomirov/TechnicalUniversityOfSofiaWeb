...
if(isset($_POST['search'])){
 ...
 $rows = $queries->SelectQuery("SELECT id, programme, programmename, coursename, optional, semester, code, lecturer FROM cources WHERE coursename LIKE '%".$gf->clean_xss($_POST['search'])."%'");
