...
$gf = new glb_funcs();
if($gf->logged_in() == false){
    header("Location:/index.php");
}
require_once($_SERVER['DOCUMENT_ROOT'].'/administration/header.php');
?>
  <!-- CSS Just for demo purpose, don't include it in your project -->
  <link href="../administration/css/demo.css" rel="stylesheet" />
  <!--<link href="../administration/css/dashboard/style.css" rel="stylesheet"/>-->
      <div class="content">
        <div class="row">
          <div class="col-12">
...
?>
  <script>
    ...
    <!-- Chart JS -->
  <script src="../administration/js/plugins/chartjs.min.js"></script>